...
var (
	...
	agentStartIdentityAttribute       = dex.DefineAttribute[agentStartIdentity]("AgentStartIdentity")
	agentBootstrapAttribute           = dex.DefineAttribute[agentBootstrap]("AgentBootstrap")
	agentMutationRevisionAttribute    = dex.DefineAttribute[MutationRevision]("AgentMutationRevision")
	...
	acceptedToolApprovalsAttribute    = dex.DefineAttributeMap[acceptedToolApproval]("AcceptedToolApprovals")
	acceptedPlanExecutionsAttribute   = dex.DefineAttributeMap[acceptedPlanExecution]("AcceptedPlanExecutions")
