	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'p': // Prefix: "products/ai-agent/"
				...
				switch elem[0] {
				case 'a': // Prefix: "archived-messages"

					if l := len("archived-messages"); len(elem) >= l && elem[0:l] == "archived-messages" {
						elem = elem[l:]
					} else {
						break
					}
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleGetArchivedMessagesRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "GET",
								allowedHeaders: nil,
				...
				case 't': // Prefix: "tool-"
					...
					case 'r': // Prefix: "recoveries"

						if l := len("recoveries"); len(elem) >= l && elem[0:l] == "recoveries" {
							elem = elem[l:]
						} else {
							break
						}
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleResolveToolRecoveryRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
									allowedMethods: "POST",
				...
				case 'a': // Prefix: "archived-messages"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Read a bounded range of immutable archived messages"
					...
					case '/': // Prefix: "/recent"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.summary = "List the configured recent tail of one best-effort Agent Stream"
								r.operationID = "listRecentEvents"
								r.operationGroup = ""
								r.pathPattern = "/products/ai-agent/events/recent"
								r.args = args
								r.count = 0
								return r, true
							default:
				...
				case 't': // Prefix: "tool-"
					...
					case 'r': // Prefix: "recoveries"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = ResolveToolRecoveryOperation
								r.summary = "Resolve one exact pending manual tool recovery"
								r.operationID = "resolveToolRecovery"
								r.operationGroup = ""
								r.pathPattern = "/products/ai-agent/tool-recoveries"
								r.args = args
								r.count = 0
								return r, true
							default:
