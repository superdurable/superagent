...
def create_options_override_blueprint(app_state: ExampleApp) -> Blueprint:
    blueprint = Blueprint(
        "primitive_options_override",
        __name__,
        url_prefix="/primitives/step/options-override",
    )
