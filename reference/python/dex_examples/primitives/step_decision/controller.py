...
def create_step_decision_blueprint(app_state: ExampleApp) -> Blueprint:
    blueprint = Blueprint(
        "primitive_step_decision", __name__, url_prefix="/primitives/step/step-decision"
    )
