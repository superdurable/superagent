...
def create_heartbeat_blueprint(app_state: ExampleApp) -> Blueprint:
    blueprint = Blueprint("primitive_heartbeat", __name__, url_prefix="/primitives/step/heartbeat")
