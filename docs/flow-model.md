...
The implementation requires Dex Go SDK `v0.12.1` and Server `v0.12.1`. Each
...
Dex Server `v0.12.1` and Go SDK `v0.12.1` expose Channel size metadata in `WaitFor` and
